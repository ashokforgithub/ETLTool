 ...
 * org.mockito.BDDMockito.given; import static org.mockito.BDDMockito.then;
 ...
 * Object>(); map.add("file", resource); ResponseEntity<String> response =
 ...
 * 
 * @Test public void shouldDownloadFile() throws Exception { ClassPathResource
 * resource = new ClassPathResource("testupload.txt", getClass());
 * given(this.storageService.loadAsResource("testupload.txt")).willReturn(
 * resource);
 * 
